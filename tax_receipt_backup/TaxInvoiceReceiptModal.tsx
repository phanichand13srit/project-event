...
import type { Booking, Vendor } from '../src/lib/supabase';
...
/**
 * 🧾 TaxInvoiceReceiptModal - Backup Copy of Tax Invoice & GST Receipt Component
 * Saved in a separate backup location (tax_receipt_backup/).
 */
